 ...
 */
class Pico_Contributors_Helper_Files {
	...
	public static function getFilePath($basePath, $file_url)
	{
		$pathFile = str_replace(
			array(
				Pico_Contributors_Helper_Server::getProtocol() . '://',

				  $_SERVER[ 'SERVER_NAME' ]
				. ( $_SERVER[ 'SERVER_PORT' ] != '80' ? ":" . $_SERVER[ 'SERVER_PORT' ] : '' )
				. Pico_Contributors_Helper_Server::getUrlBaseSuffix()
			),
			'',
	...
	{
		$mimetype = Pico_Contributors_Helper_Files::getFileMimetype($pathFile);
