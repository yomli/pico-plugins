...
class ParsedownExtraPlugin extends ParsedownExtra {
    ...
    Quick and dirty way to bypass the footnotes-rendered-as-text issue.
    See https://github.com/picocms/Pico/issues/476
    If we use ParsedownExtra-Plugin with Parsedown 1.8 we don't get the fix.
